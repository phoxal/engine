use phoxal_api_component::v1::capability::depth::Depth;
use phoxal_api_component::v1::capability::lidar::Scan;
use phoxal_api_component::v1::capability::range::Sample;
...
mod tests {
    ...
    fn range_snapshot_keeps_single_truthful_beam() {
        ...
        let rays = rays_from_range_sample(
            &pose,
            &phoxal_api_component::v1::capability::range::Sample::new(1.5),
        )
    ...
    fn range_no_hit_emits_ray_at_max_range() {
        ...
        let rays = rays_from_range_sample(
            &pose,
            &phoxal_api_component::v1::capability::range::Sample::new(4.0),
        )
        .expect("valid range sample");
