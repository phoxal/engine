...
use phoxal_core_component::v1::{CapabilityRef, Component as SourceComponent};
...
mod tests {
    ...
    -> Result<()> {
        ...
        let model = phoxal_core_robot::v1::Robot::read_from_dir(&bundle_root)?;
    ...
    fn source_components(
        bundle_root: &Path,
        model: &phoxal_core_robot::v1::Robot,
        ...
        model
            ...
            .into_iter()
            .map(|component_type| {
                let component = phoxal_core_component::Component::read_from_dir(
