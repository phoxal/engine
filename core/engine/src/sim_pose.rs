...
pub fn topic(bus: &phoxal_infra_bus::Bus, robot_id: impl AsRef<str>) -> String {
...
) -> phoxal_infra_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<Pose>>> {
    phoxal_infra_bus::pubsub::publisher_builder(bus, &path(robot_id))
}
...
pub fn subscriber_builder(
    ...
    phoxal_infra_bus::pubsub::subscriber_builder(bus, &path(robot_id))
}
