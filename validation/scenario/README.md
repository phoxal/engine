# phoxal-validation-scenario

`phoxal-validation-scenario` owns serializable scenario spec and report data:
...
`phoxal-validation-scenario`, which re-exports these modules for harness consumers.
