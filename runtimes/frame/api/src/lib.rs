...
pub mod tree {
    ...
    pub fn publisher(
        bus: &phoxal_bus::Bus,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<Tree>>> {
...
pub mod r#static {
    ...
    pub fn publisher(
        bus: &phoxal_bus::Bus,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<Static>>> {
        phoxal_bus::pubsub::publisher_builder(bus, TOPIC)
    }
...
pub mod data {
    ...
    pub fn topic(bus: &phoxal_bus::Bus, frame_id: &FrameId) -> String {
    ...
    pub fn publisher<'a>(
        ...
        frame_id: &FrameId,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'a, 'static, Stamped<FrameTransform>>> {
        phoxal_bus::pubsub::publisher_builder(bus, &path(frame_id))
    }
    ...
    pub fn subscriber_builder<'a>(
        ...
        phoxal_bus::pubsub::subscriber_builder(bus, &path(frame_id))
    }
}

pub mod lookup {
    use crate::{FrameLookupRequest, FrameLookupResponse, LOOKUP_TOPIC};
    ...
    ) -> phoxal_bus::zenoh_typed::TypedGetBuilder<'a, 'static, FrameLookupResponse> {
    ...
    pub fn queryable_builder(
        ...
        phoxal_bus::zenoh_typed::TypedQueryableBuilder<
            '_,
            'static,
            FrameLookupRequest,
            FrameLookupResponse,
...
mod tests {
    ...
    use crate::{FrameLookupRequest, FrameLookupResponse, FrameTransform, Static, Tree};
