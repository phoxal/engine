pub const SCHEMA_NAME: &str = "phoxal-runtime-plan-api/v1";
...
pub const GOAL_INPUT_TOPIC: &str = phoxal_runtime_mission_api::v1::GOAL_TOPIC;
...
mod tests {
    ...
    fn schema_contracts_do_not_drift() {
        assert_eq!(SCHEMA_NAME, "phoxal-runtime-plan-api/v1");
