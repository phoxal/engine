...
pub mod heartbeat {
    ...
    pub fn publisher(
        bus: &phoxal_bus::Bus,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<Heartbeat>>> {
...
pub mod summary {
    ...
    pub fn publisher(
        bus: &phoxal_bus::Bus,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<Summary>>> {
        phoxal_bus::pubsub::publisher_builder(bus, TOPIC)
    }
...
pub mod debug {
    pub mod readiness {
        use crate::DebugReadiness;
        use phoxal_bus::pubsub::Stamped;
        use phoxal_bus::zenoh_typed::{TypedPublisherBuilder, TypedSubscriberBuilder};

        pub const TOPIC: &str = crate::DEBUG_READINESS_TOPIC;
        ...
        pub fn publisher(
            bus: &phoxal_bus::Bus,
        ) -> phoxal_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<DebugReadiness>>>
        {
            phoxal_bus::pubsub::publisher_builder(bus, TOPIC)
        }
