pub const SCHEMA_NAME: &str = "phoxal-runtime-safety-api/v1";
...
phoxal_bus::pubsub_leaf!(authorization, AUTHORIZATION_TOPIC, SafetyAuthorization);
...
pub mod debug {
    ...
    phoxal_bus::pubsub_leaf!(evidence, DEBUG_EVIDENCE_TOPIC, Evidence);
    phoxal_bus::pubsub_leaf!(stop_set, DEBUG_STOP_SET_TOPIC, StopSet);
    phoxal_bus::pubsub_leaf!(latency_budget, DEBUG_LATENCY_BUDGET_TOPIC, LatencyBudget);
...
mod tests {
    ...
    fn schema_contracts_do_not_drift() {
        assert_eq!(SCHEMA_NAME, "phoxal-runtime-safety-api/v1");
