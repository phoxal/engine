...
use phoxal_scenario::helpers::{assert_schema, fixture_robot};
...
fn p2_localization_mode_policy(common: &RobotRuntimeArgs) -> Result<()> {
    ...
    let structure = common.structure()?;
        ...
        matches!(
            phoxal_robot::v1::resolve_localize_backend(&robot.model, &robot.components),
            phoxal_robot::v1::ResolvedLocalizeBackend::OrbSlam3RgbdInertial { .. }
        ),
