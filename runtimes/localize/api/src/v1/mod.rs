pub const SCHEMA_NAME: &str = "phoxal-runtime-localize-api/v1";
...
phoxal_bus::pubsub_leaf!(state, STATE_TOPIC, LocalizationState);
phoxal_bus::pubsub_leaf!(pose, POSE_TOPIC, PoseEstimate);
phoxal_bus::pubsub_leaf!(revision, REVISION_TOPIC, LocalizationRevision);
phoxal_bus::pubsub_leaf!(keyframe, KEYFRAME_TOPIC, Keyframe);
phoxal_bus::pubsub_leaf!(correction, CORRECTION_TOPIC, PoseGraphCorrection);
...
mod v1_version_tests {
    ...
    fn api_contract_version_is_stable() {
        assert_eq!(SCHEMA_NAME, "phoxal-runtime-localize-api/v1");
