pub const SCHEMA_NAME: &str = "phoxal-runtime-joint-api/v1";
...
pub mod data {
    ...
    pub fn topic(bus: &phoxal_bus::Bus, joint_id: &JointId) -> String {
    ...
    pub fn publisher<'a>(
        ...
        joint_id: &JointId,
    ) -> phoxal_bus::Result<TypedPublisherBuilder<'a, 'static, Stamped<JointState>>> {
        phoxal_bus::pubsub::publisher_builder(bus, &path(joint_id))
    }
    ...
    pub fn subscriber_builder<'a>(
        ...
        phoxal_bus::pubsub::subscriber_builder(bus, &path(joint_id))
    }
}
...
mod v1_version_tests {
    ...
    fn api_contract_version_is_stable() {
        assert_eq!(SCHEMA_NAME, "phoxal-runtime-joint-api/v1");
