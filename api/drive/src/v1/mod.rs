...
pub mod debug {
    ...
    phoxal_infra_bus::pubsub_leaf!(saturation, DEBUG_SATURATION_TOPIC, Saturation);
    phoxal_infra_bus::pubsub_leaf!(watchdog, DEBUG_WATCHDOG_TOPIC, Watchdog);
    phoxal_infra_bus::pubsub_leaf!(kinematics, DEBUG_KINEMATICS_TOPIC, Kinematics);
}
