...
pub const DRIVE_TARGET_TOPIC: &str = phoxal_api_drive::v1::TARGET_TOPIC;
...
pub struct State {
    ...
    pub selected: Option<phoxal_api_drive::v1::Target>,
...
pub enum MotionReason {
    ...
    SafetyConstrained(phoxal_api_safety::v1::SafetyDecision),
    NoFollowTarget,
    FollowTargetStale,
...
pub struct ArbitrationCandidate {
    ...
    pub target: Option<phoxal_api_drive::v1::Target>,
    pub accepted: bool,
...
pub mod state {
    ...
    ) -> phoxal_infra_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<State>>> {
...
pub mod manual {
    ...
    pub fn publisher(
        bus: &phoxal_infra_bus::Bus,
    ) -> phoxal_infra_bus::Result<TypedPublisherBuilder<'_, 'static, Stamped<ManualCommand>>> {
        phoxal_infra_bus::pubsub::publisher_builder(bus, TOPIC)
    }
...
pub mod debug {
    ...
    phoxal_infra_bus::pubsub_leaf!(arbitration, DEBUG_ARBITRATION_TOPIC, Arbitration);
