...
phoxal_infra_bus::pubsub_leaf!(target, TARGET_TOPIC, Target);
phoxal_infra_bus::pubsub_leaf!(state, STATE_TOPIC, State);

pub mod debug {
    use super::*;

    phoxal_infra_bus::pubsub_leaf!(tracking_error, DEBUG_TRACKING_ERROR_TOPIC, TrackingError);
    phoxal_infra_bus::pubsub_leaf!(candidates, DEBUG_CANDIDATES_TOPIC, Candidates);
    phoxal_infra_bus::pubsub_leaf!(costs, DEBUG_COSTS_TOPIC, Costs);
