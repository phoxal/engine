...
phoxal_infra_bus::pubsub_leaf!(data, DATA_TOPIC, OdometryEstimate);
phoxal_infra_bus::pubsub_leaf!(status, STATUS_TOPIC, Status);
...
pub mod debug {
    ...
    pub mod residuals {
        ...
        use crate::v1::Residuals;

        pub const TOPIC: &str = crate::v1::DEBUG_RESIDUALS_TOPIC;
    ...
    phoxal_infra_bus::pubsub_leaf!(integration, DEBUG_INTEGRATION_TOPIC, Integration);
}
...
mod tests {
    ...
    use crate::v1::{Integration, OdometryEstimate, Residuals, SourceHealth, Status};
